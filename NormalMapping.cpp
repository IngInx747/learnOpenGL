...
// Global Variables
const char* APP_TITLE = "Advanced Lighting -- Normal Mapping";
...
int main() {
	...
	Plane objectFloor;
	objectFloor.AddTexture("Resources/default/brickwall.jpg", TEX_DIFFUSE,  true);
	objectFloor.AddTexture("Resources/default/brickwall.jpg", TEX_SPECULAR, true);
	objectFloor.AddTexture("Resources/default/brickwall_normal.jpg", TEX_NORMAL);

	Cube objectBox;
	objectBox.AddTexture("Resources/default/brickwall.jpg", TEX_DIFFUSE,  true);
	objectBox.AddTexture("Resources/default/brickwall.jpg", TEX_SPECULAR, true);
	objectBox.AddTexture("Resources/default/brickwall_normal.jpg", TEX_NORMAL);

	// Shader loader
	Shader objectShader("shaders/normalmap.vert", "shaders/normalmap.frag");
	...
	while (!glfwWindowShouldClose(gWindow)) {
		...
		std::string information = std::to_string(use_gamma);
		information = "Gamma correction: " + information + "\t\t\r";
		...
		modelMatrix = glm::rotate(modelMatrix, degree, glm::vec3(1.0f, 0.0f, 0.0f));
		objectShader.use();
