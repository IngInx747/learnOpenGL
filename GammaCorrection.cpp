...
// Global Variables
const char* APP_TITLE = "Advanced Lighting";
...
int main() {
	...
	Plane objectFloor;
	objectFloor.AddTexture("Resources/default/wood.png", TEX_DIFFUSE,  true);
	objectFloor.AddTexture("Resources/default/wood.png", TEX_SPECULAR, true);

	// Shader loader
	Shader objectShader("shaders/gamma.vert", "shaders/gamma.frag");
