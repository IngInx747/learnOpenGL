...
int main() {
	...
	Plane objectFloor;
	objectFloor.AddTexture("Resources/default/wood.png", TEX_DIFFUSE);
	objectFloor.AddTexture("Resources/default/wood.png", TEX_SPECULAR);

	// Shader loader
	Shader objectShader("shaders/advlight.vert", "shaders/advlight.frag");
	...
	// Point light
	objectShader.setUniform("uPointLight.position",  pointLightPos);
