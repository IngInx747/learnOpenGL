...
void main() {
	...
	// Depth testing
	//vec3 fadingColor = vec3(LinearizeDepth(gl_FragCoord.z));
	vec3 fadingColor = vec3(1.0 - gl_FragCoord.z);

	// Result
	vec3 resultColor = directionalLightColor * fadingColor + spotLightColor;
