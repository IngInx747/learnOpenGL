...
int main()
{
    ...
    // -------------------------
    ShaderProgram simpleDepthShader, debugDepthQuad;
    simpleDepthShader.loadShaders("shaders/shadow_map.vert", "shaders/shadow_map.frag");
    debugDepthQuad.loadShaders("shaders/shadow_debug.vert", "shaders/shadow_debug.frag");
